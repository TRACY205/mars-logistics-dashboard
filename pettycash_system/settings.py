...
# Where Django puts collected static files
...
# Authentication URLs
LOGIN_URL = "/login/"             # should point to your login page
LOGIN_REDIRECT_URL = "/dashboard/"  # after successful login
LOGOUT_REDIRECT_URL = "/login/"

# Date formatting
DATE_INPUT_FORMATS = ["%d/%m/%Y"]   # accept dd/mm/yyyy in forms
DATE_FORMAT = "d/m/Y"               # display dd/mm/yyyy in templates
